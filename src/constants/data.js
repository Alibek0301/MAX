...
export const translations = {
  ru: {
    ...
    partnerDriversTitle: 'Переходите с Яндекс GO в MAX Taxi',
    partnerDriversSubtitle: 'На выгодных условиях и с полным сопровождением',
    partnerDriversText: 'Устали от агрессивных комиссий и скрытых штрафов? Мы предлагаем прозрачные условия, заказы по высокому чеку и моментальные выплаты. Подключаем водителей с личным авто.',
    partnerDriversButton: 'Оставить заявку',
    driverBadge: 'Специально для водителей',
    driverBenefit1Title: 'Честный заработок',
    driverBenefit1Desc: 'Минимальная комиссия парка. Вы сразу видите конечную стоимость поездки и маршрут — никаких скрытых сборов.',
    driverBenefit2Title: 'Свободный график',
    driverBenefit2Desc: 'Работайте на себя, когда вам удобно. Выбирайте корпоративные заказы или трансферы из аэропорта.',
    driverBenefit3Title: 'Моментальные выплаты',
    driverBenefit3Desc: 'Выводите заработанные деньги на любую карту Kaspi или Halyk в любой день, без задержек.',
    driverBenefit4Title: 'Адекватные клиенты',
    driverBenefit4Desc: 'Наши клиенты ценят комфорт и готовы платить больше за качественный сервис. Никаких эконом-тарифов.',
  ...
  kk: {
    ...
    partnerDriversTitle: 'Яндекс GO-дан MAX Taxi-ге ауысыңыз',
    partnerDriversSubtitle: 'Тиімді шарттармен және толық сүйемелдеумен',
    partnerDriversText: 'Жоғары комиссия мен жасырын айыппұлдардан шаршадыңыз ба? Біз мөлдір шарттар, жоғары чекті тапсырыстар және жылдам төлемдер ұсынамыз. Өз көліктері бар жүргізушілерді қосамыз.',
    partnerDriversButton: 'Өтінім қалдыру',
    driverBadge: 'Жүргізушілер үшін арнайы',
    driverBenefit1Title: 'Адал табыс',
    driverBenefit1Desc: 'Парктің ең төменгі комиссиясы. Сіз сапардың соңғы құнын және бағытын бірден көресіз — жасырын алымдар жоқ.',
    driverBenefit2Title: 'Еркін кесте',
    driverBenefit2Desc: 'Өзіңізге ыңғайлы уақытта жұмыс істеңіз. Корпоративтік тапсырыстарды немесе әуежайдан трансферлерді таңдаңыз.',
    driverBenefit3Title: 'Жылдам төлемдер',
    driverBenefit3Desc: 'Тапқан ақшаңызды кез келген Kaspi немесе Halyk картасына кез келген күні кідіріссіз шығарыңыз.',
    driverBenefit4Title: 'Керемет клиенттер',
    driverBenefit4Desc: 'Біздің клиенттер жайлылықты бағалайды және сапалы қызмет үшін көбірек төлеуге дайын. Эконом-тарифтер жоқ.',
  ...
  en: {
    ...
    partnerDriversTitle: 'Switch from Yandex GO to MAX Taxi',
    partnerDriversSubtitle: 'On favorable terms with full support',
    partnerDriversText: 'Tired of aggressive commissions and hidden fines? We offer transparent terms, high-paying orders, and instant payouts. Connect with your personal vehicle.',
    partnerDriversButton: 'Apply now',
    driverBadge: 'Especially for drivers',
    driverBenefit1Title: 'Fair Earnings',
    driverBenefit1Desc: 'Minimal park commission. You immediately see the final trip cost and route — no hidden fees.',
    driverBenefit2Title: 'Flexible Schedule',
    driverBenefit2Desc: 'Work for yourself whenever it suits you. Choose corporate orders or airport transfers.',
    driverBenefit3Title: 'Instant Payouts',
    driverBenefit3Desc: 'Withdraw your earnings to any Kaspi or Halyk card on any day, without delays.',
    driverBenefit4Title: 'Great Clients',
    driverBenefit4Desc: 'Our clients value comfort and are ready to pay more for quality service. No economy fares.',
