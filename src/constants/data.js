...
export const translations = {
  ru: {
    ...
    navWork: 'Работа в парке',
    navGuarantees: 'Гарантии',
    headerCta: 'Стать партнёром',
    headerMenuCta: 'Заполнить анкету',
    appsTitle: 'Приложения для работы',
    appsSubtitle: 'Скачайте нужные приложения для старта — всё в одном месте.',
    yandexProDesc: 'Принимайте заказы через официальное приложение Яндекс Про — удобный интерфейс, встроенный навигатор и полная история поездок.',
    yandexProSub: 'Основное приложение водителя',
    alamanDesc: 'Платформа для управления доходом и мотивацией водителей. Отслеживайте заработок, бонусы и статистику прямо в приложении.',
    alamanSub: 'Платформа мотивации водителей',
  },
  kk: {
    ...
    navWork: 'Паркте жұмыс',
    navGuarantees: 'Кепілдіктер',
    headerCta: 'Серіктес болу',
    headerMenuCta: 'Сауалнаманы толтыру',
    appsTitle: 'Жұмыс қолданбалары',
    appsSubtitle: 'Бастау үшін қажетті қолданбаларды жүктеңіз — бәрі бір жерде.',
    yandexProDesc: 'Яндекс Про ресми қолданбасы арқылы тапсырыстар қабылдаңыз — ыңғайлы интерфейс, навигатор және сапарлар тарихы.',
    yandexProSub: 'Жүргізушінің негізгі қолданбасы',
    alamanDesc: 'Жүргізушілердің табысы мен мотивациясын басқару платформасы. Табысыңызды, бонустарыңызды және статистикаңызды тікелей қолданбада бақылаңыз.',
    alamanSub: 'Жүргізуші мотивациясының платформасы',
  }
}
