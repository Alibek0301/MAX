...
export const translations = {
  ru: {
    ...
    partnerDriversTitle: 'Подключайтесь к Яндекс Такси через парк MAX',
    partnerDriversSubtitle: 'Надежный официальный партнер с лучшими условиями',
    partnerDriversText: 'Ищете честный таксопарк для работы в Яндекс Такси? Мы предлагаем низкую комиссию, поддержку и моментальные выплаты. Подключаем водителей с личным авто за 10 минут.',
    partnerDriversButton: 'Стать партнером',
    driverBadge: 'Водителям Яндекс Такси',
    driverBenefit1Title: 'Низкая комиссия парка',
    driverBenefit1Desc: 'Прозрачные расчеты и отсутствие скрытых сборов. Вы отдаете минимальный процент с каждого заказа.',
    driverBenefit2Title: 'Свободный график',
    driverBenefit2Desc: 'Работайте, когда вам удобно. Вы сами решаете, сколько времени проводить на линии Яндекс GO.',
    driverBenefit3Title: 'Моментальные выплаты 24/7',
    driverBenefit3Desc: 'Выводите заработанные деньги на карты Kaspi или Halyk в любой день, в любое время суток.',
    driverBenefit4Title: 'Поддержка на линии',
    driverBenefit4Desc: 'Официальный сертифицированный партнер. Всегда на связи для решения любых вопросов по клиентам и заказам.',
