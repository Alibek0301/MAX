            ...
            <div className="flex justify-between items-center h-14 px-3">
                {viewMode === 'client' ? (
                    <>
                        ...
                        <button onClick={() => { document.getElementById('standards')?.scrollIntoView({ behavior: 'smooth' }) }} className="flex flex-col items-center justify-center w-[60px] h-full text-gray-400 active:text-accent transition-colors">
                            <ShieldCheck size={19} className="mb-1" />
                            <span className="text-[9px] font-medium tracking-wide uppercase">Стандарты</span>
                        </button>

                        {/* Center CTA — Booking */}
                        <button onClick={() => { document.getElementById('fleet')?.scrollIntoView({ behavior: 'smooth' }) }} className="flex flex-col items-center justify-center w-[70px] h-full relative text-accent">
                        ...
                        <button onClick={() => { document.getElementById('services')?.scrollIntoView({ behavior: 'smooth' }) }} className="flex flex-col items-center justify-center w-[60px] h-full text-gray-400 active:text-accent transition-colors">
