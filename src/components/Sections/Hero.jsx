        ...
        <section className="relative w-full min-h-[90vh] flex items-center pt-28 pb-20 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 w-full relative z-10 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                ...
                >
                    ...
                    <motion.div variants={fadeUp} className="max-w-xl text-gray-400 text-sm sm:text-base lg:text-lg space-y-3 sm:space-y-4 mb-8 lg:mb-10 leading-relaxed font-light">
                        <p>{t.heroP1}</p>
                        <p className="hidden md:block">{t.heroP2}</p>
                    </motion.div>

                    <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4 sm:gap-5 w-full sm:w-auto mt-2">
                        <a
                            href="#booking"
