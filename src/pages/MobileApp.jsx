...
const benefits = [
    ...
    { icon: MapPin, title: 'Заказы трансфера', desc: 'Дополнительный заработок на выгодных внутригородских и междугородних заказах от таксопарка и наших партнеров.' },
        ...
        <div className="pb-[calc(6.5rem+env(safe-area-bottom))] bg-[#050505] min-h-screen text-white selection:bg-accent selection:text-black">
            ...
            <div id="for-drivers" className="relative min-h-[70vh] flex flex-col justify-end px-5 pb-12 pt-20 overflow-hidden scroll-mt-20">
                ...
                <div className="relative z-10 space-y-6">
                    ...
                    <p className="text-gray-400 text-sm leading-relaxed max-w-[90%]">
                        Надежный сертифицированный таксопарк MAX. Официальный партнер Яндекс.Такси с прозрачными условиями, низкими комиссиями и стабильными выплатами.
                    </p>
